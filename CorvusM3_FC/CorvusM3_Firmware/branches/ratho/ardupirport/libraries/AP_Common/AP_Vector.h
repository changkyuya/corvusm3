...
public:
    ...
    // printing
    void print(const char * msg="", size_t format=0) const {
        Serial1.print(msg);
        for (size_t i=0; i<getSize(); i++) {
            Serial1.print((*this)(i),format);
            Serial1.print(" ");
        }
        Serial1.println();
    }
    ...
    static bool selfTest() {
        Serial1.println("Vector self test.");
        Vector u(3),v(3),w(3);
        u(0) = 1;
        u(1) = 2;
        u(2) = 3;
        ...
        u.print(Serial1,"u: ");
        v.print(Serial1,"v: ");
        (u+v).print(Serial1,"u + v: ");
        (u-v).print(Serial1,"u - v: ");
        Serial1.print("u dot v: ");
        Serial1.println(u.dot(v));
        Serial1.print("size of u: ");
        Serial1.println(u.getSize());
        Serial1.print("size of v: ");
        Serial1.println(v.getSize());
        w=u.cross(v);
        w.print(Serial1,"u cross v: ");
        Serial1.print("size of u cross v: ");
        Serial1.println(w.getSize());
        return true;
    }
