...
void getCopterAnglesFilterACC(vs32 * gyroAngle, vs32 * accAngle, vs32 * copterAngle)
{
	...
	u32 accForce = (parameter[PARA_ACC_FORCE] * 100 / factorDegree) + parameter[PARA_ACC_FORCE];
	u32 gyroCorr = (parameter[PARA_GYRO_CORR] * 100 / factorDegree) + parameter[PARA_GYRO_CORR];
