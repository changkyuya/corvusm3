...
void remoteChannelMapping(void) 
{
  ...
  remote_assignment[0] = ((int)parameter[CHANNEL_ASSIGNMENT]) / 1000;
  remote_assignment[1] = ((int)parameter[CHANNEL_ASSIGNMENT] % 1000) / 100;
  remote_assignment[2] = ((int)parameter[CHANNEL_ASSIGNMENT] % 100) / 10;
  remote_assignment[3] = ((int)parameter[CHANNEL_ASSIGNMENT] % 10);
}
