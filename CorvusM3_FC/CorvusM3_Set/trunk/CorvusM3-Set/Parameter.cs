...
namespace CorvusM3
{
    class Parameter
    {
        ...
        [CategoryAttribute("Sensors"), DisplayName("ACC offset X [10]"), DescriptionAttribute("Default 2057")]
        public float acc_offset_x
        {
            set { parameter[10] = value; serialComm.setParameter(10, value); }
            get { return parameter[10]; }
        }
        [CategoryAttribute("Sensors"), DisplayName("ACC offset Y [11]"), DescriptionAttribute("Default 2044")]
        public float acc_offset_y
        {
            set { parameter[11] = value; serialComm.setParameter(11, value); }
            get { return parameter[11]; }
        }
        [CategoryAttribute("Sensors"), DisplayName("ACC offset Z [12]"), DescriptionAttribute("Default 2052")]
        ...
        [CategoryAttribute("DCM"), DisplayName("YAW P [15]"), DescriptionAttribute("Default 1.0")]
        public float Kp_YAW
        {
        ...
        [CategoryAttribute("Basis"), DisplayName("Batterie warning Volt [31]"), DescriptionAttribute("Default 10")]
