...
namespace CorvusM3
{
    public class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(Properties.Resources.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(Properties.Resources.VerticalSpeedNeedle);
