...
namespace CorvusM3
{
    public class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(Properties.Resources.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(Properties.Resources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(Properties.Resources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(Properties.Resources.Bandeau_Dérouleur);
