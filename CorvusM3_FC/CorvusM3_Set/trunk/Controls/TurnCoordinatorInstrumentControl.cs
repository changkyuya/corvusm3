...
namespace CorvusM3
{
    public class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(Properties.Resources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(Properties.Resources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(Properties.Resources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(Properties.Resources.TurnCoordinatorMarks);
