...
namespace CorvusM3
{
    public class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(Properties.Resources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(Properties.Resources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(Properties.Resources.HeadingIndicator_Aircraft);
